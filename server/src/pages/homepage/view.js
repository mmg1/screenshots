                ...
                {is57 ? (
                  <Localized id="homePageGetStartedDescriptionPageAction">
                    <p>
                      ...
                      the address bar, and the Screenshots menu will appear on
                  ...
                  <Localized id="homePageGetStartedDescription">
                    <p>
                      ...
                      and the Screenshots menu will appear on top of your
                      browser window.
                    </p>
                  </Localized>
                )}
            ...
            <div className="container">
              <div className="section-content align-right">
                ...
                <Localized id="homePageCaptureRegionDescription">
                  <p>
                    Click and drag to select the area you want to capture. Or
                    just hover and click — Screenshots will select the area for
                    you. Like what you see? Select Save to access your
                    screenshot online or the down arrow button to download it to
                    your computer.
                  </p>
                </Localized>
              </div>
            ...
            <div className="container">
              ...
              >
                ...
                <Localized id="homePageShaveShareFavoriteDescription">
                  <p>
                    When you take a shot, Firefox can post your screenshot to
                    your online Screenshots library and copy the link to your
                    clipboard. We automatically store your screenshot for two
                    weeks, but you can delete shots at any time or sign in to
                    save them forever.
                  </p>
                </Localized>
              </div>
            ...
            <div className="container">
              ...
              >
                ...
                <Localized id="homePageSignInDescription">
                  <p>
                    Sign in with your Firefox Account to access your shots on
                    all of your devices. Signing in also lets you save your
                    favorite shots forever.
                  </p>
                </Localized>
              </div>
              <div
